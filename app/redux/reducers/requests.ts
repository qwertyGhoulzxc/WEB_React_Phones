...
import {AuthResponse, ChangePass} from "../../sevices/types.authService/typesAuthResponse";
import {API_URL} from "../../http";
import Cookies from 'js-cookie'
import {LoadingActions} from "./Loading.slice";
import { useRouter } from "next/router";

const {setUserData,setAuth,setErrorStatusLogin,setErrorStatusRegistr,setErrorStatusChangePass,setErrorStatusSendLink,setErrorStatusChangeName} = UserInfoActions

const {setSetAvatarServerLoading,setChangePasswordLoading,setChangeNameLoading,setReloadReduxDataLoading,setCheckAuthLoading,setRegistrationLoading,setLogOutLoading,setSendLinkLoading,setLoginLoading} = LoadingActions
