...
import {ILoadingStatus} from "../../sevices/types.authService/IUser";
...
const loadingSlice = createSlice({
    ...
    reducers:{
        ...
        setSetAvatarServerLoading:(state, action)=>{state.loadingStatus.setSetAvatarServerLoading=action.payload}
    }
})
