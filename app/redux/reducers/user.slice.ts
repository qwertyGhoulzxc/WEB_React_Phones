...
initialState,
    reducers:{
        ...
        setErrorStatusChangePass:(state, action:PayloadAction<IError>)=>{state.ChangePassError.status=action.payload.status;state.ChangePassError.message=action.payload.message},
